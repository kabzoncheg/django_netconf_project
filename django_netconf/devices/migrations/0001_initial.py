# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-26 13:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_re', models.BooleanField(editable=False, verbose_name='Device has 2 RE (True/False)')),
                ('last_checked_time', models.DateTimeField(auto_now=True, verbose_name='Device last checked time:')),
                ('last_checked_status', models.BooleanField(editable=False, verbose_name='True for UP, False for DOWN:')),
            ],
        ),
        migrations.CreateModel(
            name='DeviceConfig',
        ...
        migrations.CreateModel(
            name='DeviceInstance',
            fields=[
                ('instance_name', models.CharField(editable=False, max_length=100, primary_key=True, serialize=False)),
                ('instance_type', models.CharField(editable=False, max_length=30)),
                ('router_id', models.GenericIPAddressField(editable=False)),
                ('instance_state', models.CharField(editable=False, max_length=30)),
                ('related_device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='devices.Device')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('mac_address', models.CharField(editable=False, max_length=17, primary_key=True, serialize=False)),
                ('ip_address', models.GenericIPAddressField(editable=False)),
                ('interface_name', models.CharField(editable=False, max_length=100)),
                ('hostname', models.CharField(editable=False, max_length=100)),
                ('vpn', models.CharField(editable=False, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(editable=False, max_length=50, primary_key=True, serialize=False)),
                ('admin_status', models.BooleanField(editable=False, verbose_name='True for UP, False for DOWN:')),
                ('oper_status', models.BooleanField(editable=False, verbose_name='True for UP, False for DOWN:')),
